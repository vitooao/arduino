...
void run()
{
  ...
  analogWrite(PWM_R1, PWM_SPEED+20);
...
{
  digitalWrite(DIR_R1, LOW);
  analogWrite(PWM_R1, PWM_SPEED*0.75);
  digitalWrite(DIR_L1, HIGH);
  analogWrite(PWM_L1, PWM_SPEED*0.75);
  digitalWrite(DIR_R2, LOW);
  analogWrite(PWM_R2, PWM_SPEED*0.75);
  digitalWrite(DIR_L2, HIGH);
  analogWrite(PWM_L2, PWM_SPEED*0.75);
}
void spin_left()
{
  digitalWrite(DIR_R1, HIGH);
